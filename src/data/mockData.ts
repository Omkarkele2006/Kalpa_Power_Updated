...
export const mockDrawings: Drawing[] = [
  ...
  },
  {
    ...
    project: 'Al Dhafra Solar 2GW',
    fileType: 'both',
    approvedBy: 'Eng. Khalid Bin Saeed',
...
export const mockNotifications: Notification[] = [
  { id: '1', type: 'approval', message: 'SLR-001 Panel_Layout_Block_A approved by Dr. Sara Al-Rashid', timestamp: '2026-03-09T14:30:00', read: false },
  ...
  { id: '4', type: 'approval', message: 'SLR-005 Substation_SLD approved by Dr. Sara Al-Rashid', timestamp: '2026-03-07T16:45:00', read: true },
...
export const roleUsers: Record<UserRole, { name: string; title: string }> = {
  'designer': { name: 'Ahmed Khan', title: 'Senior CAD Designer' },
  'line-manager': { name: 'Eng. Khalid Bin Saeed', title: 'Design Line Manager' },
  'dept-head': { name: 'Dr. Sara Al-Rashid', title: 'Engineering Dept Head' },
  'site-engineer': { name: 'Omar Al-Farsi', title: 'Site Engineer' },
